...
export default function ServicesSection() {
  ...
  return (
    ...
    >
      ...
      {/* Heading */}
      <h2
        className="svc-heading font-black uppercase leading-[0.9] mb-28 md:mb-36"
        style={{
      ...
      {/* Two columns */}
      <div className="svc-cols grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 lg:gap-32">
        {[
          ...
          <div key={col.title} className="svc-col">
            {/* Category header */}
            <div className="flex items-baseline justify-between mb-10 pb-6" style={{ borderBottom: "1px solid var(--border-t)" }}>
              <h3
            ...
            <div className="flex flex-col gap-0">
              {col.items.map((s) => (
                <div
                  key={s.name}
                  className="svc-row flex items-center justify-between py-6 transition-colors duration-200"
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-mono)", color: "rgba(0,196,189,0.3)" }}
            >
              & mehr auf Anfrage
            </p>
          </div>
